...
BOOL GameMod_Init(HMODULE hModule)
{
	...
	*(uint8_t **)&CL_Vid_Restart_Complete_f = Detours::X86::DetourFunction((PBYTE)0x005D2F00, (PBYTE)&hk_CL_Vid_Restart_Complete_f); 
	...
	PatchMemory(0x00511BA0, (PBYTE)"\x02", 1);// PERK_UNLIMITEDSPRINT
	PatchMemory(0x00761154, (PBYTE)"\x02", 1);// PERK_UNLIMITEDSPRINT
	PatchMemory(0x005522C7, (PBYTE)"\x40\x00\x00\x00", 4);// PERK_FLAKJACKET
	...
	PatchMemory(0x007682CF, (PBYTE)"\x00\x20\x00\x00", 4);// PERK_DEADSHOT
